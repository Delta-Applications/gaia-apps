...
(function(exports) {
  ...
  FrequencyManager.prototype.getCurrentFrequencyObject = function(frequency) {
    ...
    var deci= StatusManager.getdecimals();
    return (frequency && this.frequencyList && this.frequencyList[frequency.toFixed(deci)]);
  };
  ...
  FrequencyManager.prototype.checkFrequencyIsFavorite = function(frequency) {
    ...
    var frequencyObject = this.frequencyList[frequency.toFixed(StatusManager.getdecimals())];
  ...
  FrequencyManager.prototype.updateFrequencyToFrequencyList = function(frequencyObject) {
    ...
    var deci = StatusManager.getdecimals();
    var updatedObject = this.frequencyList[frequencyObject.frequency.toFixed(deci)];
    if (updatedObject) {
      ...
      updatedObject.name = frequencyObject.name
        ? frequencyObject.name : (frequencyObject.frequency.toFixed(deci) + ' MHz');
      updatedObject.frequency = frequencyObject.frequency;
      updatedObject.favorite = this.checkIsValidBoolValue(frequencyObject.favorite)
    ...
    this.frequencyList[frequencyObject.frequency.toFixed(deci)] = updatedObject;
    ...
    if ((updatedObject.favorite === false) && (updatedObject.station === false)) {
      ...
      delete this.frequencyList[frequencyObject.frequency.toFixed(deci)];
    }
  ...
  FrequencyManager.prototype.getStationsFrequencyList = function() {
    ...
    this.stationsFrequencyList.sort(function(a, b) {return a.stationTime - b.stationTime});
