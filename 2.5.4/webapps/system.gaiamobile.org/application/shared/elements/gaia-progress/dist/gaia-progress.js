...
this.els.inner.classList.toggle('no-value',!value);this.els.inner.classList.toggle('increasing',!value);this._value=value;}},selected:{set:function(value){this.els.bar.classList.toggle('focus',value==='true');}}},template:`
  ...
  `});});})(typeof define=='function'&&define.amd?define:(function(n,w){'use strict';return typeof module=='object'?function(c){c(require,exports,module);}:function(c){var m={exports:{}};c(function(n){return w[n];},m.exports,m);w[n]=m.exports;};})('gaia-progress',this));},{"gaia-component":1}]},{},[2])(2)});