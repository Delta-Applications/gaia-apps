...
Bluetooth.prototype = {
  ...
  init: function bt_start() {
    ...
    // relay bluetooth pbap/map system messages
    navigator.mozSetMessageHandler('bluetooth-pbap-request',
      this._loadPbmapProfile.bind(this));
    navigator.mozSetMessageHandler('bluetooth-map-request',
      this._loadPbmapProfile.bind(this));
